          ...
          {submitted ? (
            ...
            <div className="text-center">
              ...
              <p className="text-[11px] text-gray-400 mt-4">
                Didn't get it?{' '}
                <button onClick={() => setSubmitted(false)} className="underline font-semibold" style={{ color: '#EA2D34' }}>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  onMouseLeave={(e) => { if (!mutation.isPending && email.trim()) e.currentTarget.style.backgroundColor = '#EA2D34' }}
                >
                  {mutation.isPending
              ...
              <p className="text-center text-xs text-gray-500 mt-6">
                Remembered it?{' '}
                <Link to="/login" className="font-semibold hover:underline" style={{ color: '#EA2D34' }}>
                  Sign in instead →
                </Link>
              </p>
            </>
